...
<html>
  <head>
    ...
    <title>4-1 Updated Class Routine</title>
...
<h5 class="text-center "> <storng>Fourth year first semester</strong><h5>
        <!-- Main content -->
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   if($day=='Saturday' && $time=='8:00-8:50' && $semester=='4-1')
			      {
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Saturday' && $time=='9:00-9:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Saturday' && $time=='10:00-10:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Saturday' && $time=='11:00-11:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Saturday' && $time=='12:00-11:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Saturday' && $time=='1:00-1:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Saturday' && $time=='2:00-2:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Saturday' && $time=='3:00-3:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Saturday' && $time=='4:00-4:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Sunday' && $time=='8:00-8:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Sunday' && $time=='9:00-9:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Sunday' && $time=='10:00-10:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Sunday' && $time=='11:00-11:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Sunday' && $time=='12:00-11:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Sunday' && $time=='1:00-1:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Sunday' && $time=='2:00-2:50' && $semester=='4-1')
			      {
				$query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Sunday' && $time=='3:00-3:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Sunday' && $time=='4:00-4:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Monday' && $time=='8:00-8:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Monday' && $time=='9:00-9:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Monday' && $time=='10:00-10:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Monday' && $time=='11:00-11:50' && $semester=='4-1')
			      {
				$query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Monday' && $time=='12:00-12:50' && $semester=='4-1')
			      {
				$query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Monday' && $time=='1:00-1:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Monday' && $time=='2:00-2:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Monday' && $time=='3:00-3:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Monday' && $time=='4:00-4:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Tuesday' && $time=='8:00-8:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Tuesday' && $time=='9:00-9:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Tuesday' && $time=='10:00-10:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Tuesday' && $time=='11:00-11:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Tuesday' && $time=='12:00-11:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Tuesday' && $time=='1:00-1:50' && $semester=='4-1')
			      {
				$query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Tuesday' && $time=='2:00-2:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Tuesday' && $time=='3:00-3:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Tuesday' && $time=='4:00-4:50' && $semester=='4-1')
			      {
				$query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Wednesday' && $time=='8:00-8:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Wednesday' && $time=='9:00-9:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Wednesday' && $time=='10:00-10:50' && $semester=='4-1')
			      {
				$query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Wednesday' && $time=='11:00-11:50' && $semester=='4-1')
			      {
				$query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Wednesday' && $time=='12:00-11:50' && $semester=='4-1')
			      {
				$query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Wednesday' && $time=='1:00-1:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Wednesday' && $time=='2:00-2:50' && $semester=='4-1')
			      {
				$query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Wednesday' && $time=='3:00-3:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
  ...
  while( $row = mysql_fetch_array($result))
		{
			   ...
			   $room=$row['room_no'];
			   $semester=$row['semester'];
			   if($day=='Wednesday' && $time=='4:00-4:50' && $semester=='4-1')
			      {
				 $query2="SELECT * FROM course_registration";
                 $result2=mysql_query($query2);
                   while($row2=mysql_fetch_array($result2))
